...
This web app: **This app allows you to create new crewmates. You can also update and delete previously created crewmates. The datas are stored in the table at supabase.**
...
Challenges:
- I'm having trouble with setting up the routes
- I have toruble with the css
